...
@Component({
  ...
  templateUrl: './question-player-selector.component.html',
  styleUrl: './question-player-selector.component.css'
})
export class QuestionPlayerSelectorComponent implements OnChanges {
